...
begin
   try
      opcion:=LowerCase(opcion);
      case opcion of
        'trapecio':begin Execute:=TrapesioArea(funcion,a,b,n);end;
        'simpson13':begin Execute:=Simpson13Area(funcion,a,b,n);end;
        'simpson38':begin Execute:=Simpson38Area(funcion,a,b,n);end;
       else Execute:=10101000000000;
   end;
   except
     Execute:=10101000000000;
